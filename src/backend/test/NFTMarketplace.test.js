...
describe("NFTMarketplace", function () {
  ...
  beforeEach(async function () {
    ...
    // Get signers (signers are abstractions of ethereum accounts,
    // that can be used to sign and send transactions to ethereum network)
  ...
  describe("Minting NFTS", function () {
    it("Should track each minted NFT", async function () {
      ...
      expect(await nft.tokenCount()).to.equal(2); // tokenCount = number of tokens till now.
  ...
  describe("Making marketplace items", function () {
    ...
    it("Should track newly created item, transfer NFT from seller to marketplace and emit Offered event", async function () {
      ...
      // Get item from items mapping then check to ensure they are correct.
